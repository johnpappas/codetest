...
public class PersonRecordDaoTest {
	...
	public void testGetCSVPersonRecordObject() throws PersonRecordException, ParseException{
		...
		log.info("");
		log.info("Last name: " + pr.getLastName());
		log.info("First name: " + pr.getFirstName());
		log.info("Favorite color: " + pr.getFavoriteColor());
		log.info("Gender: " + pr.getGender());
		log.info("Date: " + pr.getDateOfBirth());
	}
